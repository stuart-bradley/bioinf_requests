...
class DataFilesControllerTest < ActionController::TestCase
  ...
  test "should create data_file" do
    assert_difference('DataFile.count') do
      post :create, data_file: { attachment_uploader: @data_file.attachment_uploader, request_id: @data_file.request_id }
    end
  ...
  test "should update data_file" do
    patch :update, id: @data_file, data_file: { attachment_uploader: @data_file.attachment_uploader, request_id: @data_file.request_id }
    assert_redirected_to data_file_path(assigns(:data_file))
  end
